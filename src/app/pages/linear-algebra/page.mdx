...
> __*definition*__. The zero vector in ${\reals^n}$ is the vector ${\bold{0}^n,}$ whose components are all zero.
>
> $$
...
> __*definition*__. Let ${\bold{v}}$ be a vector in ${\reals^n,}$ and let ${k \in \reals}$ be a scalar. Then:
>
> $$
...
> __*definition*__. Given a vector ${\bold{v},}$ the negation of ${\bold{v},}$ denoted ${-\bold{v},}$ is:
>
> $$
...
> __*definition*__. Let ${m,n \in \N.}$ A real-valued ${(m,n)}$ matrix ${\bold{A}}$
...
> __*definition*__. Let ${\bold{A} \in \R^{m \times n},}$ and let ${\bold{B} \in \R^{m \times n}.}$ Then the sum ${\bold{A} + \bold{B}}$ is defined as:
>
> $$
>     \bold{A} + \bold{B} :=
>     \begin{bmatrix}
...
__*definition*__. Let ${\bold{A} \in \R^{m \times n},}$ and let ${\bold{B} \in \R^{m \times n}.}$ Then the Hadamard product ${\bold{A} \odot \bold{B}}$ is defined as:
