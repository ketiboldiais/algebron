...
> __Definition.__ Let ${u}$ be an expression. We say that ${u}$ is a __univariate monomial expression__ in a single variable ${x}$ if ${u}$ satisfies one of the following rules:
>
