...
> __Definition.__ A _multivariate polynomial_ ${u}$ in the set of symbols ${\lbrace x_1, x_2, \ldots, x_m \rbrace}$ is a finite sum with one or more monomial terms of the form
>
> $$
...
__*example*__. ${x^2 - y^2}$

__*example*__. ${mc^2}$

__*example*__. ${a + \dfrac{1}{2}ax^2 + aby.}$

__*example*__. ${ax^2 + bx + 3c.}$

__*example*__. ${3x^2 + 4.}$ 
...
> __Definition.__ Let ${c_1, c_2, \ldots, c_r}$ be algebraic expressions and let ${x_1, x_2, \ldots, x_m}$ be algebraic expressions that are not integers or fractions. A _general monomial expression_ (GME) in ${\lbrace x_1, x_2, \ldots, x_m \rbrace}$ is an expression of the form
>
> $$
...
> __Definition.__ A general polynomial expression (GPE) is a GME or a sum of GMEs.
...
> __*definition*__. The square function is a function of the form
>
> $$
>  f(x) = x^2.
> $$
...
> __*definition*__. The cube function ${f}$ is defined as
>
> $$
>  f(x) = x^3.
> $$
...
> __*definition*__. A polynomial function ${f}$ is a function of the form
>
> $$
...
> __*theorem*__. Suppose ${f}$ is a polynomial function of the form
>
> $$
>  f(x) = a_n x^n + a_{n-1} x^{n-1} + \ldots + a_1 x + a_0
> $$
...
> __*definition*__. A rational function ${r}$ is a function of the form
>
> $$
>  r(x) = \dfrac{f(x)}{g(x)},
> $$
...
> __*definition*__. Let ${b}$ denote an arbitrary constant, with ${b \gt 0}$ and ${b \neq 1.}$ The exponential function ${f}$ with base ${b}$ is a function of the form
>
> $$
>  f(x) = ab^{kx},
> $$
...
__*example*__. ${f(x) = 2^x.}$ Below is ${f}$'s graph.
