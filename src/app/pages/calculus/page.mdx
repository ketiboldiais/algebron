...
- [Real Functions](#real-functions)
  ...
  - [Quadratic Functions](#quadratic-functions)
    ...
    - [Natural Even Power Functions](#natural-even-power-functions)
...
> __Definition.__ Let ${A,}$ ${B,}$ and ${C}$ be real number constants, with ${A \neq 0.}$ A function of the form
>
> $$
>    f(x) = Ax^2 + Bx + C
> $$
...
The graph of a quadratic function is called a __parabola__. Given the quadratic function ${f(x) = Ax^2 + Bx + C,}$ if ${A \gt 0,}$ then the parabola has a _local minimum_ at ${x = -\dfrac{B}{2A}}$ and the parabola is _convex_. If ${A \lt 0,}$ then the parabola has a _local maximum_ at ${x = - \dfrac{B}{2A}}$ and the parabola is _concave_.

import {QuadraticFunctionLab} from "@/components/Fig";

<QuadraticFunctionLab/>

All parabolas have a special point called the __vertex__. This point is given by:

$$
    \left( -\dfrac{B}{2A}, \dfrac{4AC - B^2}{4A} \right).
$$

The quantity ${B^2 - 4AC}$ is called the __discriminant__ of ${Ax^2 + Bx + C.}$ The equation

$$
    y = A\left(x + \dfrac{B}{2A}\right)^2 + \dfrac{4AC - B^2}{4A}
$$

is called the __canonical equation__ of the parabola ${y = Ax^2 + Bx + C.}$ Notice that the parabola is symmetric about the vertical line ${x = -\dfrac{B}{2A},}$ passing through the vertex. This line, called the __axis of symmetry__, is parallel to the ${y}$-axis. Suppose ${(h,k)}$ is the parabola's vertex. Using the method of completing the square, the parabola's equation (with its axis of symmetry parallel to the ${y}$-axis) can be written in the form ${y = A(x - h)^2 + k.}$   

#### Quadratic Formula
The quadratic formula provides a quick and easy way to find the roots of a polynomial equation.

> __Formula.__ Let ${A,}$ ${B,}$ and ${C}$ be constants in ${\reals.}$ The roots of the equation ${Ax^2 + Bx + C = 0}$ are given by the formula
>
> $$
>    x = \dfrac{-B \pm \sqrt{B^2 - 4AC}}{2A}.
> $$
...
> __Corollary.__ Suppose ${u}$ is the quadratic ${Ax^2 + Bx + C = 0}$ with ${A \neq 0,}$ ${B,}$ and ${C}$ as real constants. Then the following are true:
>
...
### Cubic Functions
> __Definition.__ Let ${A,}$ ${B,}$ ${C,}$ and ${D}$ be real number constants with ${A \neq 0.}$ A function of the form 
>
> $$
>  f(x) = Ax^3 + Bx^2 + Cx + D
> $$
