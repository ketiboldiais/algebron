  ...
  return (
    <div>
      <main>
        ...
        <article>
          <p>
            Algebron is a JavaScript math library written in TypeScript. Largely
            motivated by necessity, I began writing Algebron as an undergraduate
          ...
          <p>
            My solution to cutting down that time: Generate the diagrams by code. Thus began Algebron&apos;s nascency–a
